...
search.classList.add('flex', 'items-center','relative' ,'justify-center','p-2.5', 'gap-[8px]', 'h-[48px]', 'border', 'rounded-md', 'border-[#467599]', 'bg-[#467599]');
...
input.classList.add( 'ml-14', 'bg-transparent', 'text-white', 'placeholder-white', 'outline-none', 'font-roboto', 'text-sm');
...
search.appendChild(input);
  ...
  function generateDropdowns(data) {
    ...
    data.forEach(item => {
      ...
      svg.setAttribute('fill', 'none');
      svg.classList.add('absolute', 'top-[45%]', 'right-2', 'pointer-events-none');
